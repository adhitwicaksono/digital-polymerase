...
**Prototype:** 001B/001C  
**Requested mode:** `chain-preserving`  
...
- Output PDB: `/mnt/data/hna_full_prototype_001C1_outputs/converted_hna_RNA-8mer_chain_preserving_001C1.pdb`
...
- Mean template/local anchor RMSD: `0.4312 Å`
- Maximum template/local anchor RMSD: `0.7019 Å`
- Mean base-transplant anchor RMSD: `0.2450 Å`
- Maximum base-transplant anchor RMSD: `0.2992 Å`
- Mean C1′→glycosidic N distance: `1.4740 Å`
...
| C1'→C2' | output | 8 | 0 | 0 | 1.665 | 1.642 | 1.685 | 1.35–1.90 | PASS |
