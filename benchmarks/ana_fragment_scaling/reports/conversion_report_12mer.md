...
- Source RNA PDB: `RNA-12mer.pdb`
- ANA fragment template PDB: `1ho6_ANApart.pdb`
- Output PDB: `converted_ana_12mer.pdb`
...
| 9 | A80 | G | GAO | GAO A9 | 0.2030 | exact base-class template |
| 10 | A81 | A | AAR | GAO A9 | 0.2017 | purine fallback: A uses G-like ANA backbone template |
| 11 | A82 | A | AAR | GAO A9 | 0.2149 | purine fallback: A uses G-like ANA backbone template |
| 12 | A83 | A | AAR | GAO A9 | 0.2093 | purine fallback: A uses G-like ANA backbone template |
