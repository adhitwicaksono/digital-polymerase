...
- Source RNA PDB: `RNA-16mer.pdb`
- ANA fragment template PDB: `1ho6_ANApart.pdb`
- Output PDB: `converted_ana_16mer.pdb`
...
|---:|---|---|---|---|---:|---|
| 1 | A67 | A | AAR | GAO A9 | 0.2033 | purine fallback: A uses G-like ANA backbone template |
| 2 | A68 | C | CAR | CAR A11 | 0.2026 | exact base-class template |
| 3 | A69 | C | CAR | CAR A11 | 0.2066 | exact base-class template |
| 4 | A70 | A | AAR | GAO A9 | 0.2044 | purine fallback: A uses G-like ANA backbone template |
| 5 | A71 | C | CAR | CAR A11 | 0.2077 | exact base-class template |
| 6 | A72 | C | CAR | CAR A11 | 0.2089 | exact base-class template |
| 7 | A73 | U | UAR | UAR A10 | 0.1897 | exact base-class template |
| 8 | A74 | A | AAR | GAO A9 | 0.2042 | purine fallback: A uses G-like ANA backbone template |
| 9 | A75 | G | GAO | GAO A9 | 0.1975 | exact base-class template |
| 10 | A76 | G | GAO | GAO A9 | 0.2089 | exact base-class template |
| 11 | A77 | C | CAR | CAR A11 | 0.1979 | exact base-class template |
| 12 | A78 | U | UAR | UAR A10 | 0.2161 | exact base-class template |
| 13 | A79 | C | CAR | CAR A11 | 0.2058 | exact base-class template |
| 14 | A80 | G | GAO | GAO A9 | 0.2030 | exact base-class template |
| 15 | A81 | A | AAR | GAO A9 | 0.2017 | purine fallback: A uses G-like ANA backbone template |
| 16 | A82 | A | AAR | GAO A9 | 0.2149 | purine fallback: A uses G-like ANA backbone template |
