...
| O3'(i)→P(i+1) | output | 21 | 0 | 19 | 2.635 | 0.847 | 5.302 | 1.40–1.80 | FAIL |
| P(i)→O5'(i) | source | 22 | 0 | 0 | 1.591 | 1.588 | 1.595 | 1.40–1.80 | PASS |
| P(i)→O5'(i) | output | 22 | 0 | 0 | 1.611 | 1.611 | 1.612 | 1.40–1.80 | PASS |
...
| 3 | `A81:O3' → A82:P` | 3.585 | 1.40–1.80 | FAIL |  |
| 4 | `A70:O3' → A71:P` | 3.514 | 1.40–1.80 | FAIL |  |
| 5 | `A71:O3' → A72:P` | 3.330 | 1.40–1.80 | FAIL |  |
| 6 | `A76:O3' → A77:P` | 2.951 | 1.40–1.80 | FAIL |  |
| 7 | `A74:O3' → A75:P` | 2.850 | 1.40–1.80 | FAIL |  |
| 8 | `A79:O3' → A80:P` | 2.836 | 1.40–1.80 | FAIL |  |
| 9 | `A72:O3' → A73:P` | 2.808 | 1.40–1.80 | FAIL |  |
| 10 | `A69:O3' → A70:P` | 2.673 | 1.40–1.80 | FAIL |  |
| 11 | `A67:O3' → A68:P` | 2.655 | 1.40–1.80 | FAIL |  |
| 12 | `A68:O3' → A69:P` | 2.616 | 1.40–1.80 | FAIL |  |
| 13 | `A73:O3' → A74:P` | 2.591 | 1.40–1.80 | FAIL |  |
| 14 | `A63:O3' → A64:P` | 2.374 | 1.40–1.80 | FAIL |  |
| 15 | `A80:O3' → A81:P` | 0.847 | 1.40–1.80 | FAIL |  |
| 16 | `A78:O3' → A79:P` | 0.935 | 1.40–1.80 | FAIL |  |
| 17 | `A62:O3' → A63:P` | 2.263 | 1.40–1.80 | FAIL |  |
| 18 | `A65:O3' → A66:P` | 2.241 | 1.40–1.80 | FAIL |  |
| 19 | `A82:O3' → A83:P` | 1.031 | 1.40–1.80 | FAIL |  |
...
|---:|---|---|---|---|---:|---|
| 1 | A62 | A | AAR | GAO A9 | 0.1559 | purine fallback: A uses G-like ANA backbone template |
| 2 | A63 | U | UAR | UAR A10 | 0.1821 | exact base-class template |
| 3 | A64 | A | AAR | GAO A9 | 0.3106 | purine fallback: A uses G-like ANA backbone template |
| 4 | A65 | C | CAR | CAR A11 | 0.1552 | exact base-class template |
| 5 | A66 | G | GAO | GAO A9 | 0.1621 | exact base-class template |
| 6 | A67 | A | AAR | GAO A9 | 0.3215 | purine fallback: A uses G-like ANA backbone template |
| 7 | A68 | C | CAR | CAR A11 | 0.3288 | exact base-class template |
| 8 | A69 | C | CAR | CAR A11 | 0.3306 | exact base-class template |
| 9 | A70 | A | AAR | GAO A9 | 0.3166 | purine fallback: A uses G-like ANA backbone template |
| 10 | A71 | C | CAR | CAR A11 | 0.3287 | exact base-class template |
| 11 | A72 | C | CAR | CAR A11 | 0.3313 | exact base-class template |
| 12 | A73 | U | UAR | UAR A10 | 0.2972 | exact base-class template |
| 13 | A74 | A | AAR | GAO A9 | 0.3154 | purine fallback: A uses G-like ANA backbone template |
| 14 | A75 | G | GAO | GAO A9 | 0.3038 | exact base-class template |
| 15 | A76 | G | GAO | GAO A9 | 0.3309 | exact base-class template |
| 16 | A77 | C | CAR | CAR A11 | 0.3203 | exact base-class template |
| 17 | A78 | U | UAR | UAR A10 | 0.3562 | exact base-class template |
| 18 | A79 | C | CAR | CAR A11 | 0.3358 | exact base-class template |
| 19 | A80 | G | GAO | GAO A9 | 0.3195 | exact base-class template |
| 20 | A81 | A | AAR | GAO A9 | 0.3193 | purine fallback: A uses G-like ANA backbone template |
| 21 | A82 | A | AAR | GAO A9 | 0.3413 | purine fallback: A uses G-like ANA backbone template |
| 22 | A83 | A | AAR | GAO A9 | 0.3277 | purine fallback: A uses G-like ANA backbone template |
