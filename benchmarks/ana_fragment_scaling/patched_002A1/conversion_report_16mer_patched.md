...
| O3'(i)→P(i+1) | output | 15 | 0 | 15 | 2.965 | 0.847 | 5.302 | 1.40–1.80 | FAIL |
| P(i)→O5'(i) | source | 16 | 0 | 0 | 1.591 | 1.589 | 1.595 | 1.40–1.80 | PASS |
| P(i)→O5'(i) | output | 16 | 0 | 0 | 1.611 | 1.611 | 1.612 | 1.40–1.80 | PASS |
...
| 14 | `A80:O3' → A81:P` | 0.847 | 1.40–1.80 | FAIL |  |
| 15 | `A78:O3' → A79:P` | 0.935 | 1.40–1.80 | FAIL |  |
...
|---:|---|---|---|---|---:|---|
| 1 | A67 | A | AAR | GAO A9 | 0.3215 | purine fallback: A uses G-like ANA backbone template |
| 2 | A68 | C | CAR | CAR A11 | 0.3288 | exact base-class template |
| 3 | A69 | C | CAR | CAR A11 | 0.3306 | exact base-class template |
| 4 | A70 | A | AAR | GAO A9 | 0.3166 | purine fallback: A uses G-like ANA backbone template |
| 5 | A71 | C | CAR | CAR A11 | 0.3287 | exact base-class template |
| 6 | A72 | C | CAR | CAR A11 | 0.3313 | exact base-class template |
| 7 | A73 | U | UAR | UAR A10 | 0.2972 | exact base-class template |
| 8 | A74 | A | AAR | GAO A9 | 0.3154 | purine fallback: A uses G-like ANA backbone template |
| 9 | A75 | G | GAO | GAO A9 | 0.3038 | exact base-class template |
| 10 | A76 | G | GAO | GAO A9 | 0.3309 | exact base-class template |
| 11 | A77 | C | CAR | CAR A11 | 0.3203 | exact base-class template |
| 12 | A78 | U | UAR | UAR A10 | 0.3562 | exact base-class template |
| 13 | A79 | C | CAR | CAR A11 | 0.3358 | exact base-class template |
| 14 | A80 | G | GAO | GAO A9 | 0.3195 | exact base-class template |
| 15 | A81 | A | AAR | GAO A9 | 0.3193 | purine fallback: A uses G-like ANA backbone template |
| 16 | A82 | A | AAR | GAO A9 | 0.3413 | purine fallback: A uses G-like ANA backbone template |
