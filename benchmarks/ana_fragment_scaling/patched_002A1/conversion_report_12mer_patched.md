...
|---|---|---:|---:|---:|---:|---:|---:|---|---|
| O3'(i)→P(i+1) | source | 11 | 0 | 0 | 1.607 | 1.604 | 1.610 | 1.40–1.80 | PASS |
| O3'(i)→P(i+1) | output | 11 | 0 | 11 | 2.793 | 0.847 | 5.302 | 1.40–1.80 | FAIL |
| P(i)→O5'(i) | source | 12 | 0 | 0 | 1.592 | 1.590 | 1.595 | 1.40–1.80 | PASS |
| P(i)→O5'(i) | output | 12 | 0 | 0 | 1.611 | 1.611 | 1.612 | 1.40–1.80 | PASS |
...
| 4 | `A76:O3' → A77:P` | 2.951 | 1.40–1.80 | FAIL |  |
| 5 | `A74:O3' → A75:P` | 2.850 | 1.40–1.80 | FAIL |  |
| 6 | `A79:O3' → A80:P` | 2.836 | 1.40–1.80 | FAIL |  |
| 7 | `A72:O3' → A73:P` | 2.808 | 1.40–1.80 | FAIL |  |
| 8 | `A73:O3' → A74:P` | 2.591 | 1.40–1.80 | FAIL |  |
| 9 | `A80:O3' → A81:P` | 0.847 | 1.40–1.80 | FAIL |  |
| 10 | `A78:O3' → A79:P` | 0.935 | 1.40–1.80 | FAIL |  |
| 11 | `A82:O3' → A83:P` | 1.031 | 1.40–1.80 | FAIL |  |
...
| 9 | A80 | G | GAO | GAO A9 | 0.3195 | exact base-class template |
| 10 | A81 | A | AAR | GAO A9 | 0.3193 | purine fallback: A uses G-like ANA backbone template |
| 11 | A82 | A | AAR | GAO A9 | 0.3413 | purine fallback: A uses G-like ANA backbone template |
| 12 | A83 | A | AAR | GAO A9 | 0.3277 | purine fallback: A uses G-like ANA backbone template |
