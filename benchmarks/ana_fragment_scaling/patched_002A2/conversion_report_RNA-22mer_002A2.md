...
- Output PDB: `/mnt/data/ana_patch_002A2_outputs/converted_ana_RNA-22mer_002A2.pdb`
...
|---|---|---:|---:|---:|---:|---:|---:|---|---|
| O3'(i)→P(i+1) | source | 21 | 0 | 0 | 1.606 | 1.603 | 1.610 | 1.40–1.80 | PASS |
| O3'(i)→P(i+1) | output | 21 | 0 | 0 | 1.606 | 1.603 | 1.610 | 1.40–1.80 | PASS |
| P(i)→O5'(i) | source | 22 | 0 | 0 | 1.591 | 1.588 | 1.595 | 1.40–1.80 | PASS |
...
|---:|---|---|---|---|---:|---|
| 1 | A62 | A | AAR | GAO A9 | 0.1212 | purine fallback: A uses G-like ANA backbone template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 2 | A63 | U | UAR | UAR A10 | 0.1377 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 3 | A64 | A | AAR | GAO A9 | 0.0324 | purine fallback: A uses G-like ANA backbone template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 4 | A65 | C | CAR | CAR A11 | 0.1362 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 5 | A66 | G | GAO | GAO A9 | 0.1179 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 6 | A67 | A | AAR | GAO A9 | 0.0355 | purine fallback: A uses G-like ANA backbone template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 7 | A68 | C | CAR | CAR A11 | 0.0484 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 8 | A69 | C | CAR | CAR A11 | 0.0422 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 9 | A70 | A | AAR | GAO A9 | 0.0296 | purine fallback: A uses G-like ANA backbone template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 10 | A71 | C | CAR | CAR A11 | 0.0385 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 11 | A72 | C | CAR | CAR A11 | 0.0394 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 12 | A73 | U | UAR | UAR A10 | 0.0326 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 13 | A74 | A | AAR | GAO A9 | 0.0287 | purine fallback: A uses G-like ANA backbone template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 14 | A75 | G | GAO | GAO A9 | 0.0265 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 15 | A76 | G | GAO | GAO A9 | 0.0369 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 16 | A77 | C | CAR | CAR A11 | 0.0448 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 17 | A78 | U | UAR | UAR A10 | 0.0644 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 18 | A79 | C | CAR | CAR A11 | 0.0524 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 19 | A80 | G | GAO | GAO A9 | 0.0331 | exact base-class template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 20 | A81 | A | AAR | GAO A9 | 0.0346 | purine fallback: A uses G-like ANA backbone template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 21 | A82 | A | AAR | GAO A9 | 0.0398 | purine fallback: A uses G-like ANA backbone template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
| 22 | A83 | A | AAR | GAO A9 | 0.0329 | purine fallback: A uses G-like ANA backbone template; ANA chain-preserving mode: source chain atoms preserved, C2'/O2' template-derived |
