...
|---|---|---:|---:|---:|---:|---:|---:|---|---|
| C1'→C2' | source | 22 | 0 | 0 | 1.527 | 1.521 | 1.530 | 1.35–1.75 | PASS |
| C1'→C2' | output | 22 | 0 | 0 | 1.544 | 1.508 | 1.561 | 1.35–1.75 | PASS |
| C2'→C3' | source | 22 | 0 | 0 | 1.522 | 1.520 | 1.525 | 1.35–1.75 | PASS |
| C2'→C3' | output | 22 | 0 | 0 | 1.513 | 1.500 | 1.536 | 1.35–1.75 | PASS |
| C2'→F2' | output | 22 | 0 | 0 | 1.382 | 1.381 | 1.384 | 1.25–1.50 | PASS |
...
|---:|---|---|---|---|---:|---:|---|
| 1 | A62 | A | A5L | A5L A4 | 0.0438 | 1.3816 | exact base-class template |
| 2 | A63 | U | UFL | TAF A3 | 0.0939 | 1.3835 | exact base-class template |
| 3 | A64 | A | A5L | A5L A4 | 0.0614 | 1.3816 | exact base-class template |
| 4 | A65 | C | CFL | CFL A2 | 0.0666 | 1.3806 | exact base-class template |
| 5 | A66 | G | GFL | GFL A1 | 0.0594 | 1.3838 | exact base-class template |
| 6 | A67 | A | A5L | A5L A4 | 0.0596 | 1.3816 | exact base-class template |
| 7 | A68 | C | CFL | CFL A2 | 0.0419 | 1.3806 | exact base-class template |
| 8 | A69 | C | CFL | CFL A2 | 0.0496 | 1.3806 | exact base-class template |
| 9 | A70 | A | A5L | A5L A4 | 0.0711 | 1.3816 | exact base-class template |
| 10 | A71 | C | CFL | CFL A2 | 0.0559 | 1.3806 | exact base-class template |
| 11 | A72 | C | CFL | CFL A2 | 0.0550 | 1.3806 | exact base-class template |
| 12 | A73 | U | UFL | TAF A3 | 0.0380 | 1.3835 | exact base-class template |
| 13 | A74 | A | A5L | A5L A4 | 0.0726 | 1.3816 | exact base-class template |
| 14 | A75 | G | GFL | GFL A1 | 0.0594 | 1.3838 | exact base-class template |
| 15 | A76 | G | GFL | GFL A1 | 0.0438 | 1.3838 | exact base-class template |
| 16 | A77 | C | CFL | CFL A2 | 0.0431 | 1.3806 | exact base-class template |
| 17 | A78 | U | UFL | TAF A3 | 0.0310 | 1.3835 | exact base-class template |
| 18 | A79 | C | CFL | CFL A2 | 0.0391 | 1.3806 | exact base-class template |
| 19 | A80 | G | GFL | GFL A1 | 0.0477 | 1.3838 | exact base-class template |
| 20 | A81 | A | A5L | A5L A4 | 0.0589 | 1.3816 | exact base-class template |
| 21 | A82 | A | A5L | A5L A4 | 0.0564 | 1.3816 | exact base-class template |
| 22 | A83 | A | A5L | A5L A4 | 0.0650 | 1.3816 | exact base-class template |
