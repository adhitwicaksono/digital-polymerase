...
|---|---|---:|---:|---:|---:|---:|---:|---|---|
| C1'→C2' | source | 16 | 0 | 0 | 1.527 | 1.522 | 1.530 | 1.35–1.75 | PASS |
| C1'→C2' | output | 16 | 0 | 0 | 1.550 | 1.526 | 1.561 | 1.35–1.75 | PASS |
| C2'→C3' | source | 16 | 0 | 0 | 1.522 | 1.520 | 1.523 | 1.35–1.75 | PASS |
| C2'→C3' | output | 16 | 0 | 0 | 1.508 | 1.500 | 1.516 | 1.35–1.75 | PASS |
| C2'→F2' | output | 16 | 0 | 0 | 1.382 | 1.381 | 1.384 | 1.25–1.50 | PASS |
...
|---:|---|---|---|---|---:|---:|---|
| 1 | A67 | A | A5L | A5L A4 | 0.0596 | 1.3816 | exact base-class template |
| 2 | A68 | C | CFL | CFL A2 | 0.0419 | 1.3806 | exact base-class template |
| 3 | A69 | C | CFL | CFL A2 | 0.0496 | 1.3806 | exact base-class template |
| 4 | A70 | A | A5L | A5L A4 | 0.0711 | 1.3816 | exact base-class template |
| 5 | A71 | C | CFL | CFL A2 | 0.0559 | 1.3806 | exact base-class template |
| 6 | A72 | C | CFL | CFL A2 | 0.0550 | 1.3806 | exact base-class template |
| 7 | A73 | U | UFL | TAF A3 | 0.0380 | 1.3835 | exact base-class template |
| 8 | A74 | A | A5L | A5L A4 | 0.0726 | 1.3816 | exact base-class template |
| 9 | A75 | G | GFL | GFL A1 | 0.0594 | 1.3838 | exact base-class template |
| 10 | A76 | G | GFL | GFL A1 | 0.0438 | 1.3838 | exact base-class template |
| 11 | A77 | C | CFL | CFL A2 | 0.0431 | 1.3806 | exact base-class template |
| 12 | A78 | U | UFL | TAF A3 | 0.0310 | 1.3835 | exact base-class template |
| 13 | A79 | C | CFL | CFL A2 | 0.0391 | 1.3806 | exact base-class template |
| 14 | A80 | G | GFL | GFL A1 | 0.0477 | 1.3838 | exact base-class template |
| 15 | A81 | A | A5L | A5L A4 | 0.0589 | 1.3816 | exact base-class template |
| 16 | A82 | A | A5L | A5L A4 | 0.0564 | 1.3816 | exact base-class template |
