...
|---|---|---:|---:|---:|---:|---:|---:|---|---|
| C1'→C2' | source | 12 | 0 | 0 | 1.527 | 1.522 | 1.530 | 1.35–1.75 | PASS |
| C1'→C2' | output | 12 | 0 | 0 | 1.549 | 1.526 | 1.561 | 1.35–1.75 | PASS |
| C2'→C3' | source | 12 | 0 | 0 | 1.522 | 1.520 | 1.523 | 1.35–1.75 | PASS |
| C2'→C3' | output | 12 | 0 | 0 | 1.509 | 1.500 | 1.516 | 1.35–1.75 | PASS |
| C2'→F2' | output | 12 | 0 | 0 | 1.382 | 1.381 | 1.384 | 1.25–1.50 | PASS |
...
| 9 | A80 | G | GFL | GFL A1 | 0.0477 | 1.3838 | exact base-class template |
| 10 | A81 | A | A5L | A5L A4 | 0.0589 | 1.3816 | exact base-class template |
| 11 | A82 | A | A5L | A5L A4 | 0.0564 | 1.3816 | exact base-class template |
| 12 | A83 | A | A5L | A5L A4 | 0.0650 | 1.3816 | exact base-class template |
